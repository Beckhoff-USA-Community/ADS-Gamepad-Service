...
Builds are included for TwinCAT RT x86, TwinCAT RT x64 and TwinCAT OS x64. The source lives in the project repository on GitHub for anyone who prefers to build and sign the module with their own certificate; the TcCOM page of the documentation covers both paths.
